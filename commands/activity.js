    ...
    execute(message, args) {
        ...
        for(let p=0; p<activityFile.LootTableIndexes.length;p++){
            ...
            if(activityFile.LootTableIndexes[p].maxToDrop === 1){
                description = `${description}**${activityFile.LootTableIndexes[p].names.Name}** [${activityFile.LootTableIndexes[p].LootTableIndex}] - **${activityFile.LootTableIndexes[p].percent}%** For **1** Item\n`
            }
            else if(activityFile.LootTableIndexes[p].minToDrop === activityFile.LootTableIndexes[p].maxToDrop){
                description = `${description}**${activityFile.LootTableIndexes[p].names.Name}** [${activityFile.LootTableIndexes[p].LootTableIndex}] - **${activityFile.LootTableIndexes[p].percent}%** For **${activityFile.LootTableIndexes[p].minToDrop}** Items\n`
            }else{
                description = `${description}**${activityFile.LootTableIndexes[p].names.Name}** [${activityFile.LootTableIndexes[p].LootTableIndex}] - **${activityFile.LootTableIndexes[p].percent}%** For **${activityFile.LootTableIndexes[p].minToDrop} - ${activityFile.LootTableIndexes[p].maxToDrop}** Items\n`
